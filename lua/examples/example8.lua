...
return_value = HelpHandler.handle(nil) --We can also then ONLY check what happened with a nil value, and no help dialogue will be output

if HELP_HANDLER_ALL_MATCHED == return_value then --This will only have output the program version (1.0), only because it was set above
